...
__global__ void picolm_q6_imma_debug_verify(const void *weights, const int8_t *xq, const float *xd, float *y_imma, float *y_scalar, int S, int I, int O, int row_bytes, int y_stride);
